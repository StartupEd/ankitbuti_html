        ...
        {articles.map((a) => (
          ...
          >
            ...
            <div className="space-y-1.5 mb-2">
              <div className="text-[13px] font-medium text-gray-600 dark:text-gray-400">{a.source}</div>
              <h3 className="font-semibold text-gray-800 dark:text-gray-100">
                <a className="before:absolute before:inset-0" href={a.url} target="_blank" rel="noopener noreferrer">
                  {a.title}
                </a>
              </h3>
            </div>
